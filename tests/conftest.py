    ...
    json_response = [
        {
            ...
            "CanEditParent": True,
            "HasDashboards": True,
            "HasCustomExportTemplates": True,
            "HasV2Workflows": True,
            "Levels": [{"Level": 0, "Name": "string", "Description": "string"}],
            "IsDescriptionEnabled": True,
            "IsDescriptionVisibleByDefault": True,
            "IsDefaultReadAccessEnabled": True,
            "DescriptionButtonName": "string",
            "SynonymAllocations": ["00000000-0000-0000-0000-000000000000"],
            "CreatedOn": "2025-04-08T13:01:31.089Z",
            "CreatedByUid": "00000000-0000-0000-0000-000000000000",
            "CreatedByName": "string",
            "UpdatedOn": "2025-04-08T13:01:31.089Z",
